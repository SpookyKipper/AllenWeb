...
Config::SetType('util.request.ua', ConfigType::String);
...
Config::SetType('util.header.cache_control.public', ConfigType::Bool);
Config::SetType('util.header.cache_control.no_cache', ConfigType::Bool);
Config::SetType('util.header.cache_control.no_store', ConfigType::Bool);
Config::SetType('util.header.cache_control.max_age', ConfigType::Int);
Config::SetType('util.header.cache_control.must_revalidate', ConfigType::Bool);
